...
<section class="content">
    <div class="container box" style="margin-bottom:0px; padding-top:15px">
        Hubungi Admin jika ada masalah dalam aplikasi.</br><hr>
        <div style="padding-bottom:15px; padding-left:5px; padding-right:5px; text-align-last: justify; width: 300px">
